...
Онлайн-тренажёр для двух самостоятельных учеников: однодневный интенсив по созданию AI-агента с ИИ-напарником, светлая и тёмная темы, тесты с проходным баллом 70% и реальный Python прямо в браузере через Pyodide.

Актуальные первоисточники и добавленные темы зафиксированы в [sources.md](sources.md).

Обязательный маршрут рассчитан на 3–5 часов и состоит из 7 шагов: минимальный Python, функции, LLM API, цикл агента, контекст, function calling и проверка перед релизом. Остальные темы остаются в библиотеке после интенсива.
